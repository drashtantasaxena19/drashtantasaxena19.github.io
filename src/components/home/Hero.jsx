...
export default function Hero() {
    ...
    return (
        <section
            id="home"
            className="relative isolate mt-20 min-h-[calc(100svh-80px)] overflow-hidden bg-[#03060d] py-12 sm:py-16 lg:h-[calc(100svh-80px)] lg:min-h-[680px] lg:py-0"
        >
            <motion.div
                initial={
                    reduceMotion
            ...
            >
                ...
                <div
                    className="absolute inset-0 bg-no-repeat opacity-25 sm:opacity-30 lg:hidden"
                    style={{
                        backgroundImage:
                            "url('/assets/images/backgrounds/hero-bg.png')",
